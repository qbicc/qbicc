 ...
 */
public class MockObjectDeserializer extends ObjectDeserializer {
    ...
    public Object allocateClass(int typeId, boolean longLived, boolean immortal) {
        switch (typeId) {
            case TYPEID_TEST1:
                return new TestDeserialization.Test1();
            case TYPEID_TEST2:
                return new TestDeserialization.Test2();
            default:
    ...
    public Object[] allocateReferenceArray(int elementTypeId, int length, boolean longLived, boolean immortal) {
        switch (elementTypeId) {
            ...
            case TYPEID_TEST1:
                return new TestDeserialization.Test1[length];
            case TYPEID_TEST2:
                return new TestDeserialization.Test2[length];
            default:
                throw new RuntimeException("Unexpected elementTypeId " + elementTypeId);
        }
    }
    ...
    public void deserializeInstanceFields(int typeId, Object obj, Deserializer deser) {
        switch (typeId) {
            case TYPEID_TEST1:
                deserialize_Test1((TestDeserialization.Test1) obj, deser); break;
            case TYPEID_TEST2:
                deserialize_Test2((TestDeserialization.Test2) obj, deser); break;
            default:
                throw new RuntimeException("Unexpected typeid " + typeId);
        }
    }
