...
public final class InstanceInvocationValue extends AbstractValue implements InstanceOperation, MethodInvocation, DispatchInvocation, Triable {
    ...
    InstanceInvocationValue(final Node callSite, final ExecutableElement element, final int line, final int bci, final Node dependency, final Kind kind, final Value instance, final MethodElement target, final ValueType type, final List<Value> arguments) {
