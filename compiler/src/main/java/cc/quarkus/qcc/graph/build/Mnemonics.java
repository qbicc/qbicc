...
public class Mnemonics {
    ...
    private static final Map<Integer, String> MNEMONICS = new HashMap<Integer, String>() {{
        ...
        put(IASTORE, "IASTORE");
        put(LASTORE, "LIASTORE");
        put(FASTORE, "FIASTORE");
        put(DASTORE, "DIASTORE");
        put(AASTORE, "AIASTORE");
        put(BASTORE, "BIASTORE");
        put(CASTORE, "CIASTORE");
        put(SASTORE, "SIASTORE");
    ...
    public static String of(int opcode) {
