...
public final class ArrayElementRead extends AbstractValue implements ArrayElementOperation, OrderedNode {
    ...
    ArrayElementRead(final Node callSite, final ExecutableElement element, final int line, final int bci, final Node dependency, final ValueType type, final Value instance, final Value index, final JavaAccessMode mode) {
