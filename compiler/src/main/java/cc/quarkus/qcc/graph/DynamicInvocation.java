...
public final class DynamicInvocation extends AbstractNode implements /* MethodInvocation, TODO: am I a MethodInvocation? */ Triable, Action {
    ...
    DynamicInvocation(final Node callSite, final ExecutableElement element, final int line, final int bci, final Node dependency, final MethodElement bootstrapMethod, final List<Value> staticArguments, final List<Value> arguments) {
