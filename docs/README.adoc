...
[source,shell]
-----
jbang --quiet cc.quarkus:qcc-main:1.0.0-SNAPSHOT --boot-module-path /path/to/main.jar:~/.m2/repository/cc/quarkus/qccrt-java.base/11.0.1-SNAPSHOT/qccrt-java.base-11.0.1-SNAPSHOT.jar:~/.m2/repository/cc/quarkus/qcc-runtime-unwind/1.0.0-SNAPSHOT/qcc-runtime-unwind-1.0.0-SNAPSHOT.jar:~/.m2/repository/cc/quarkus/qcc-runtime-api/1.0.0-SNAPSHOT/qcc-runtime-api-1.0.0-SNAPSHOT.jar:~/.m2/repository/cc/quarkus/qcc-runtime-gc-nogc/1.0.0-SNAPSHOT/qcc-runtime-gc-nogc-1.0.0-SNAPSHOT.jar --output-path /tmp/output hello/world/Main
-----
