...
[source,shell]
-----
jbang --quiet org.qbicc:qbicc-main:0.50.0 --app-path-file /path/to/main.jar --output-path /tmp/output hello/world/Main
-----
...
[source,shell]
-----
jbang --quiet org.qbicc:qbicc-main:0.50.0 --app-path-file /path/to/main.jar --output-path /tmp/output --rt-version=17.alpha.0.NNN-SNAPSHOT hello/world/Main
-----
