...
[source,shell]
-----
jbang --quiet org.qbicc:qbicc-main:0.23.0-SNAPSHOT --boot-path-append-file /path/to/main.jar --output-path /tmp/output hello/world/Main
-----
...
[source,shell]
-----
jbang --quiet org.qbicc:qbicc-main:0.23.0-SNAPSHOT --boot-path-append-file /path/to/main.jar --output-path /tmp/output --rt-version=17.alpha.0.NNN-SNAPSHOT hello/world/Main
-----
